    ...
    <div className="bg-gray-50 min-h-screen pb-10">
      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-300 rounded-2xl my-10 p-8 sm:p-12 shadow-md">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-12">
          <Avatar className="h-24 w-24 sm:h-28 sm:w-28 border-2 border-orange-500 shadow-lg flex items-center justify-center text-xl font-bold bg-orange-100 text-orange-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
          ...
          />
          <ProfileInfo
            icon={<Contact className="w-6 h-6 text-orange-500" />}
            label="Phone"
          ...
          <ProfileInfo
            ...
            label="Address"
            value={`${user?.profile?.address || "NA"}, ${
              user?.profile?.pincode || "NA"
            }`}
          />
          <ProfileInfo
